...
public class Captcha {
     ...
     * @param: checkCode
     * @param: request
     * @updateTime: 2019/10/28 19:25
     * @return: java.util.Map<java.lang.String,java.lang.String>
     */
    public static Map<String,String> captchaDetection(Map<String,String> map,
                                                      HttpSession session,
                                                      String checkCode,
        ...
        if (StringUtils.isEmpty(checkCode) || captcha == null || !(checkCode.equalsIgnoreCase(captcha))) {
            ...
            map.put("flag","验证码错误，请重新输入！");
            return map;
            //判断是否超过一分钟
        } else if ((now - codeTime) /60000 > 1) {
            map.put("flag","验证码已失效，请重新输入！");
            return map;
        }
        return map;
    }
